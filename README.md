...
## Missing features
The language lacks the following features: operator precedence, empty declarations, empty return statements, tables/arrays, object-oriented programming, "break"/"continue" statements, "goto" statements, coroutines/async, and comments.
